...
update_option( 'wp_quiz_version' , '1.0.3' );

$quiz_settings = get_option( 'wp_quiz_default_settings' );
// Create Settings
if( $quiz_settings === false ){
...
wp_mkdir_p( $wq_upload_dir[ 'basedir' ] . "/wp_quiz-export/" );
wp_mkdir_p( $wq_upload_dir[ 'basedir' ] . "/wp_quiz-import/" );

chmod( $wq_upload_dir[ 'basedir' ], 0777 );
chmod( $wq_upload_dir[ 'basedir' ] . "/wp_quiz-export/", 0777 );
chmod( $wq_upload_dir[ 'basedir' ] . "/wp_quiz-import/", 0777 );
