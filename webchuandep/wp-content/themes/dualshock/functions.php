...
function mts_enqueue_css() {
	...
	$custom_css = "
		...
		body {background-image: url({$mts_options['mts_bg_pattern_upload']});}
		.sbutton { border-color:{$mts_options['mts_color_scheme']};}
		footer .widget li a:hover, .sidebar.c-4-12 a:hover, .copyrights a, .title a:hover, .pagination a, .pagination2, .post-info a, .readMore a:hover, .secondary-navigation a:hover, .sidebar .textwidget a, footer .textwidget a, .single_post .tags a { color:{$mts_options['mts_color_scheme']}; }	
		.sbutton, .top .toplink, .mts-subscribe input[type='submit'], .related-posts li, .flex-control-paging li a.flex-active, #commentform input#submit, .reply a, #wp-calendar thead th, #wp-calendar td:hover, #wp-calendar td a:hover, #wp-calendar td:hover a, #tabber .inside li, .pagination a, .pagination2, .tagcloud a { background-color:{$mts_options['mts_color_scheme']}; color: #fff!important; }
		{$mts_sclayout}
