<?php
define( 'MTS_THEME_VERSION', '1.2.3' );
...
add_action('wp_enqueue_scripts','wcd_theme_define_scripts');
function wcd_theme_define_scripts() {
	$theme_url = get_template_directory_uri();	
	wp_enqueue_style( 'wcd-theme-globals', $theme_url . '/globals.css' );    
}
