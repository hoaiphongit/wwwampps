		...
		<article class="article">
			...
			<?php if (is_author()) { ?>
				<div class="postauthor">
					<h4>Posts By : <?php if(get_query_var('author_name')) : $curauth = get_user_by('slug', get_query_var('author_name')); else : $curauth = get_userdata(get_query_var('author')); endif; ?><?php echo $curauth->nickname; ?></h4>
